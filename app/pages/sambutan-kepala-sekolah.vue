  ...
  <div role="main" class="main">
    ...
    <div class="container py-5 mt-3">
      <div class="row align-items-center">
        ...
        <div class="col-lg-8">
          <h2 class="text-color-dark font-weight-normal text-5 mb-4">
            Selamat Datang di <strong class="font-weight-extra-bold">Portal Resmi Kami</strong>
          </h2>
          
          <p class="lead text-4 line-height-6 text-dark font-weight-semibold">
            Assalamu’alaikum Warahmatullahi Wabarakatuh, <br>
            Puji syukur senantiasa kita panjatkan kehadirat Allah SWT yang telah melimpahkan rahmat dan karunia-Nya kepada kita semua.
          </p>
          ...
          <p>
            Melalui website ini, kami berharap dapat memberikan informasi yang transparan dan akurat mengenai berbagai kegiatan akademik maupun non-akademik, prestasi siswa, serta program-program unggulan yang ada di sekolah kami. Kami berkomitmen untuk terus meningkatkan mutu pendidikan demi mencetak generasi yang cerdas, berakhlak mulia, dan berdaya saing tinggi.
          </p>
