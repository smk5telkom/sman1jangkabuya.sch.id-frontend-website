...
const submitEdit = async (id) => {
    try {
        await apiRequest(`/announcements/${id}`, {
            method: 'PATCH',
            body: {
                title: announcements.value.title,
                content: announcements.value.content,
                type: announcements.value.type,
                typeTitle: announcements.value.typeTitle,
                typeContent: announcements.value.typeContent,
            }
        });

        alert('berhasil')
        // getAnnouncements(announcements.value.id)
    ...
    <div class="d-flex min-vh-100 bg-light">
        ...
        <main class="flex-grow-1 main-content">
            ...
            <div class="container-fluid p-4">
                <h4 class="mb-4 fw-bold">Prestasi</h4>
                ...
                <div class="card border-0 shadow-sm rounded-4">
                    <div class="card-body p-4">
                        ...
                        <form @submit.prevent="submitEdit(announcements.id)">
                            <div class="mb-3">
                                <label class="form-label">Judul</label>
                                <input v-model="announcements.title" type="text" class="form-control" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Isi Pengumuman</label>
                                <textarea v-model="announcements.content" class="form-control" rows="5" required></textarea>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Tipe</label>
                                <select v-model="announcements.type" class="form-select">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Judul Tipe</label>
                                <input v-model="announcements.typeTitle" class="form-control" type="text">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Isi Tipe</label>
                                <input v-model="announcements.typeContent" class="form-control" type="text">
                            </div>
                            <div class="text-end mt-4">
                                <button type="button" class="btn btn-secondary me-2" @click="cancelEdit">Batal</button>
