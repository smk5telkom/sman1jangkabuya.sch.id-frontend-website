...
const getPosts = async (id) => {
    try {
        ...
        console.log(posts.value.imageUrl)
    } catch(err) {
        console.log(err)
    }
}
            ...
            <div class="container-fluid p-4">
                ...
                <div class="card border-0 shadow-sm rounded-4">
                    <div class="card-body p-4">
                        ...
                        <form @submit.prevent="submitEdit(posts.id)">
                            <div class="mb-3">
                                <label class="form-label">Gambar Saat Ini:</label>
                                <img :src="`http://localhost:3000${posts.imageUrl}`" style="max-width: 200px" class="img-thumbnail" alt="thumbnail">
                            </div>
                            <div class="mb-3">
